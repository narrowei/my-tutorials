<template>
  <div class="about">
 <h1> My tutorial </h1>
 <p1> My-Tutorials is a platform where students could seek for tutorials as well as tutors could register tutorials. The website is lightweight, interactive, RESTful, 
could support reasonable size Database. The front-end and back-end are powered by Vue.JS and Node.JS respectively.
</p1>
<h2> Features </h2>
<p2>
...
<h3> Technologies  </h3>
<p3>My-Tutorials uses a number of open source projects to work properly:
